        ...
        <div className="flex flex-col h-full">
            ...
            <div className="bg-white rounded-lg shadow-md overflow-hidden mb-6 flex-shrink-0">
                <div className="p-8 bg-gradient-to-r from-blue-50 to-white">
                    ...
                    <p className="text-lg text-gray-600 max-w-2xl">
                        A comprehensive tool platform for single-cell drug response mapping.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <Link href="/readme" className="block">
                    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer hover:bg-gray-50">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="ml-3 text-xl font-semibold text-gray-800">README</h3>
                        </div>
                        <p className="text-gray-600">Please read the README before using the LLM tools.</p>
                    </div>
                </Link>

                {/* LLM Training Card */}
                <Link href="/AnalysisTool" className="block">
                    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer hover:bg-gray-50">
                        <div className="flex items-center mb-4">
                            ...
                            <h3 className="ml-3 text-xl font-semibold text-gray-800">LLM Tools</h3>
                        </div>
                        <p className="text-gray-600">Run LLMs tools using your single-cell data and drug responses.</p>
                    </div>
                </Link>
                ...
                <Link href="/Data" className="block">
                    <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow cursor-pointer hover:bg-gray-50">
                        ...
                        <p className="text-gray-600">Browse and download related datasets and analysis results.</p>
                    </div>
                </Link>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <p className="ml-4 text-gray-600">Adjust parameter if necessary</p>
                    </div>
                    <div className="flex items-center">
                        ...
                        <p className="ml-4 text-gray-600">Download and explore results</p>
                    </div>
                </div>
            </div>
        </div>
