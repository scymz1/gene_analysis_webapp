...
import argparse
from evaluate_get_embed import AnndataProcessor
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir_data', type=str, default='/blue/qsong1/wang.qing/benchmark_dataset_API/UCE/samples/',
                        help='path to data')
    parser.add_argument('--dir_shape', type=str, default='./dict_samples_shape.pkl',
                        help='path to shape dict') 
    parser.add_argument('--dir_ebds', type=str, default='/blue/qsong1/wang.qing/benchmark_dataset_API/UCE/ebds/',
                        help='path to ebds') 
