...
def buildDataset(args):
    vocab_file = os.path.join(os.path.dirname(__file__), '..', 'save', 'vocab.json')
    model_config_file = os.path.join(os.path.dirname(__file__), '..', 'save', 'args.json')
    ...
    for f in files_list_all:
        dt_path = os.path.join(args.data_path, f)
