...
class Args:
    def __init__(self, **kwargs):
        ...
        self.data_path = "/blue/qsong1/wang.qing/benchmark_dataset_API/scGPT/samples/"
        self.lr = 0.0001
        self.train_rate = 0.8
        self.ft_list = ['none']
...
# parser.add_argument('--data_path', type=str, default="/blue/qsong1/wang.qing/benchmark_dataset_API/scGPT/samples/", help='')
